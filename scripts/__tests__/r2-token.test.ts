...
import { secretFromTokenValue, isMate, opItemNames, parseRollArgs, runlogEnv } from "../lib/r2Token.js";
...
test("opItemNames match the env-var names the workflows read", () => {
  assert.deepEqual(opItemNames("R2"), {
    accessKeyId: "R2_ACCESS_KEY_ID",
    secretAccessKey: "R2_SECRET_ACCESS_KEY",
    tokenValue: "R2_TOKEN_VALUE",
  });
  assert.equal(opItemNames("R2_READONLY").secretAccessKey, "R2_READONLY_SECRET_ACCESS_KEY");
});
